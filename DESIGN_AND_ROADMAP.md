...
2. After pulling, record its exact digest — e.g. `docker inspect --format='{{index .RepoDigests 0}}' <image>` (or `docker manifest inspect`) — never guess or hand-derive a digest.
